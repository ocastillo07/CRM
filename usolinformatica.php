...
//Class definition
class usolinformatica extends Page
{
   ...
   function usolinformaticaShow($sender, $params)
   {
      ...
      if(isset($_GET['idsolicitud']))
      {
         ...
         else
         {
            ...
            {
               if(Derechos('Eliminar Solicitudes de Informatica') == false)
               {
                  echo '<script language="javascript" type="text/javascript">
                    alert("No Tienes el Derecho para Eliminar Solicitudes de Informatica");
                    window.location="usolinformaticavista.php";
                    </script>';
               }
               else
               {
                  ...
                  dmconexion::Log("Elimino la Solicitudes de Informatica no. " . $this->edidsolicitud->Text .
                  " Del originador " . $this->edoriginador->Text, 3);

                  redirect("usolinformaticavista.php");
               }
            }
         }
      }
...
<?php
   ...
   {
      if(Derechos('Alta Solicitudes de Informatica') == false)
         echo '<script language="javascript" type="text/javascript">
                  alert("No puede dar de Alta Solicitudes de Informatica");
                </script>';
      else
         redirect("usolinformatica.php?idsolicitud=0&folio=0");
   }
...
?>
   basicAjax('usolinformatica_ajax.php','cbestatuschange=1'+
...
<?php
   ...
   function usolinformaticaJSLoad($sender, $params)
   {
...
<?php
   ...
   {
      if(Derechos('Modificar Solicitudes de Informatica'))
      {
         if($this->cbestatus->ItemIndex == '111')
         {
            echo '<script language="javascript" type="text/javascript">
               alert(\'Ya no puedes agregar mas notas, la Solicitud de Informatica esta Cerrada!\');
               </script>';
         }
         else if($this->hfidsolicitud->Value != '0')
            redirect("unotas.php?idnota=" . $this->hfidsolicitud->Value . "&procedencia=solinformatica" .
         ...
         echo '<script language="javascript" type="text/javascript">
               alert("No puede Modificar Solicitudes de Informatica");
               window.location="usolinformaticavista.php";
               </script>';
   }
   ...
   function mcorreccionDblClick($sender, $params)
   {
      if(Derechos('Modificar Solicitudes de Informatica'))
      {
         if($this->cbestatus->ItemIndex == '111')
         {
            ...
            redirect("unotas.php?idnota=" . $this->hfidcorreccion->Value . "&procedencia=solinformatica" .
            "&idprocedencia=" . $this->edidsolicitud->Text);
         else
            echo '<script language="javascript" type="text/javascript">
                  alert("Primero escribe un comentario en el recuadro");
      ...
      if(Derechos('Modificar Solicitudes de Informatica'))
      {
         if($this->cbestatus->ItemIndex == '111')
         {
            ...
            if($this->hfidanalisis->Value != '0')
               redirect("unotas.php?idnota=" . $this->hfidanalisis->Value . "&procedencia=solinformatica" .
               "&idprocedencia=" . $this->edidsolicitud->Text);
         else
            echo '<script language="javascript" type="text/javascript">
                  alert("Primero escribe un comentario en el recuadro");
   ...
   function mdescripcionDblClick($sender, $params)
   {
      if(Derechos('Modificar Solicitudes de Informatica'))
      {
         if($this->cbestatus->ItemIndex == '111')
         {
            ...
            redirect("unotas.php?idnota=" . $this->hfidproblema->Value . "&procedencia=solinformatica" .
            "&idprocedencia=" . $this->edidsolicitud->Text);
         else
            echo '<script language="javascript" type="text/javascript">
                     alert("Primero escribe un comentario en el recuadro");
   ...
   {
      if(Derechos('Eliminar Archivo Solicitud de Informatica') == false)
      {
         echo '<script language="javascript" type="text/javascript">
      ...
      else
      {
         if($no == 1)
         {
            ...
            $this->hfpath1->Value = '';
            $sql = ' update solinformatica set path1="' . $this->hfpath1->Value .
         ...
         if($no == 2)
         {
            ...
            $this->hfpath2->Value = '';
            $sql = ' update solinformatica set path2="' . $this->hfpath2->Value .
            '" where idsolicitud =' . $this->edidsolicitud->Text;
            $rs = mysql_query($sql)or die('Error de consulta SQL: ' . $sql . ' ' . mysql_error());
   ...
   {
      if(Derechos('Subir ArchivoSolicitud') == false)
      {
         echo '<script language="javascript" type="text/javascript">
   ...
   function guardar()
   {
      ...
      if($this->hfestatus->value == 1)
      {
         $axion = 'insert into solinformatica(idclasificacion,idestatus,originador,idproceso,idprocedimiento,idnota,
         ...
         $this->hfidsolicitud->Value . ',' . $this->chksolicita->Checked . ',curdate(),"' . $this->dtcompromiso->text . '","' .
         ...
         $up = 'update solinformatica set idnotaproblema=' . $this->hfidproblema->Value . ' where idsolicitud=' . $this->edidsolicitud->Text;
         $rsup = mysql_query($up)or die("Error de Consulta SQL: " . $up . ' ' . mysql_error());
      }
      else
      {
         if(Derechos('Modificar Solicitudes de Informatica') == false)
         {
            echo '<script language="javascript" type="text/javascript">
                  alert("No puede Modificar Solicitudes de Informatica");
                  window.location="usolinformaticavista.php";
      ...
      if($this->hfestatus->value == 1 || $this->cbestatus->ItemIndex == 111)
      {
         if($this->cbestatus->ItemIndex < 111)
         {
            $msn = strtoupper($this->edoriginador->Text) . ' ha creado la Solicitud de Informatica No. ' . $this->edidsolicitud->Text .
            ...
            $correos = $row[0] . ',' . GetConfiguraciones('mailsolinformatica');
         }
         else
         {
            $msn = 'La Solicitud de Informatica No. ' . $this->edidsolicitud->text . ' se ha Cerrado, por el usuario: ' . $_SESSION['login'];
            $correos = GetConfiguraciones('mailsolinformatica');
         }
         enviarmailattach(GetConfiguraciones('mailsistema'), 'Sistema de CRM', strtolower($correos), 'Varios', 'AVISO DE SOLICITUD DE INFORMATICA REQUERIDA', $msn, '', '');
   ...
   function insertaridnotas()
   {
      ...
      #accion
      if($this->maccion->Text != '' && $this->hfidsolicitud->Value == '0')
      {
         $sql = 'insert into notas (idprocedencia,procedencia,usuario,fecha,hora) values
             (' . $this->edidsolicitud->text . ',"Solicitud-Accion","' . $_SESSION['login'] . '",curdate(),curtime())';
         $rs = mysql_query($sql)or die('Error de Consulta SQL: ' . $sql . ' ' . mysql_error());
         $this->hfidsolicitud->Value = mysql_insert_id();
         if($this->maccion->Tag == '1')
         {
            $sql4 = 'insert into notasdet(idnota,nota,usuario,fecha,hora) values(' . $this->hfidsolicitud->value .
   ...
   function lbnotasClick($sender, $params)
   {
      if($this->hfestatus->value == '2')
      {
         ...
         redirect("unotas.php?idnota=" . $this->hfidnota->Value . "&procedencia=solinformatica" .
         "&idprocedencia=" . $this->edidsolicitud->Text);
      }
      else
         echo '<script language="javascript" type="text/javascript">
   ...
   function alta()
   {
      $this->edidsolicitud->Text = MaxId('solinformatica', 'idsolicitud') + 1;
   ...
   function locate()
   {
      ...
      $r = ufh('a');
      $sql = 'select ' . $r . ' as ufh from solinformatica a where idsolicitud= ' . $this->edidsolicitud->text;
      $rs = mysql_query($sql)or die('Error de consulta SQL: ' . $sql . ' ' . mysql_error());
      $row = mysql_fetch_row($rs);
      $this->lbufh->Caption = $row[0];

      //adjuntos
      if(Derechos("Abrir Archivo Solicitudes de Informatica"))
      {
         //adjuntos
      ...
      {
         if(Derechos('Auditar Solicitudes de Informatica') == false)
         {
   ...
   function traernotas()
   {
      $sql = 'select idnota from solinformatica where idsolicitud=' . $this->edidsolicitud->Text;
      $rs = mysql_query($sql)or die('Error de consulta SQL: ' . $sql . ' ' . mysql_error());
      $row = mysql_fetch_row($rs);
      if($row[0] > 0)
         $idnota = $row[0];
   ...
   function inicializa()
   {
      ...
      //procesos
      $sql = 'select idproceso,nombre from solinformaticaprocesos where estatus=1';
      $rs = mysql_query($sql)or die('Error de consulta SQL: ' . $sql . ' ' . mysql_error());
      ...
      //procedimiento
      $sql = 'select idprocedimiento,prefijo,numero,nombre from solinformaticaprocedimientos
      ...
      $sql = 'select u.idusuario,concat(if(u.nombre="","",u.nombre)," ",
          ...
          where p.responsablesolicitud=1';
      $rs = mysql_query($sql)or die('Error de consulta SQL: ' . $sql . ' ' . mysql_error());
   ...
   function Validar()
   {
      ...
      {
         echo '<script language="javascript" type="text/javascript">
             alert("Falta el Proceso Generador de la Solicitud");
             </script>';
         return false;
      }
...
global $usolinformatica;

//Creates the form
$usolinformatica = new usolinformatica($application);

//Read from resource file
$usolinformatica->loadResource(__FILE__);

//Shows the form
$usolinformatica->show();
