...
//Class definition
class usolinformaticavista extends Page
{
   public $dsgrid = null;
   public $sqlgrid = null;
   public $grid = null;
   ...
   function usolinformaticavistaJSLoad($sender, $params)
   {
   ?>
   ...
   function usolinformaticavistaCreate($sender, $params)
   {
      if(Derechos('Accesar Solicitudes de Informatica') == false)
      {
         echo '<script language="javascript" type="text/javascript">
               alert("Usted no tiene derechos para Accesar a Solicitudes de Informatica");
   ...
   function usolinformaticavistaShow($sender, $params)
   {
   ...
   {
      if(Derechos('Exportar Solicitudes de Informatica') == false)
      {
         echo '<script language="javascript" type="text/javascript">
              alert("No tienes Derechos para Exportar Solicitudes de Informatica");
              </script>';
      }
      else
      {
   ...
   ?>
         if(!confirm('Desea Eliminar la Accion Seleccionada?'))
            return(false);
         document.location.href("usolinformatica.php?idsolicitud="+document.getElementById("hfidsolicitud").value+"&elim=1");
   <?php
   }
   ...
   function filtro()
   {
      ...
      $sql = 'SELECT a.idsolicitud as idsolicitud, if(a.idclasificacion=0,"Correctivo","Preventivo") as Clasificacion,
             ...
             from solinformatica a
             left join clasificaciones c on a.idestatus=c.idclasificacion
             left join solinformaticaprocesos ap on a.idproceso=ap.idproceso
             left join solinformaticaprocedimientos apc on a.idprocedimiento=apc.idprocedimiento
      ...
      if(Derechos('Ver todas las Solicitudes de Informatica') == true)
   ...
   {
   ?>
      document.location.href("usolinformatica.php?idsolicitud="+document.getElementById("hfidsolicitud").value);
   <?php
   }
   ...
   ?>
      ...
      document.usolinformaticavista.hfidsolicitud.value = model.getValue(0, row);
   <?php
   }
...
global $usolinformaticavista;

//Creates the form
$usolinformaticavista = new usolinformaticavista($application);

//Read from resource file
$usolinformaticavista->loadResource(__FILE__);

//Shows the form
$usolinformaticavista->show();
