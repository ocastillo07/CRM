...
//Class definition
class uactividadesxasignar2 extends Page
{
       ...
       {
         redirect("uclientesvista.php?pagina=uactividadesxasignar2.php");
       }
       ...
       function btnguardarcerrarClick($sender, $params)
       {
         ...
         {
            $this->guardar();
            redirect('uactividadesxasignarvista2.php');
         }
       }
       ...
       function guardar()
       {
         ...
         {
				$b=true;
            if(Derechos('EDACTIVXASIG2') == false)
					$b=false;
				if(Derechos('VALACTIVXASIG2'))
					$b=true;
               ...
               window.location="uactividadesxasignar2.php?idactividad='.$this->hfidactividad->Value.'";
               </script>';
				}
				else
				{
       ...
       function uactividadesxasignar2Show($sender, $params)
       {
         ...
         else if(isset($_GET["idactividad"]))
         {
            ...
            else
            {
               ...
               if(isset($_GET['elim']))
               {
                  if(Derechos('ELACTIVXASIG2') == false)
                  {
                     echo '<script language="javascript" type="text/javascript">
                     alert("No Tienes el Derecho para Eliminar Actividades por Asignar");
							document.location.href("uactividadesxasignarvista2.php");
                     </script>';
                  }
                  else
                  {
...
global $uactividadesxasignar2;

//Creates the form
$uactividadesxasignar2=new uactividadesxasignar2($application);

//Read from resource file
$uactividadesxasignar2->loadResource(__FILE__);

//Shows the form
$uactividadesxasignar2->show();
