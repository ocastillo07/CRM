...
//Class definition
class uactividadesIdealeasevista extends Page
{
       ...
       function uactividadesIdealeasevistaJSLoad($sender, $params)
       {
       ...
       function uactividadesIdealeasevistaShow($sender, $params)
       {
...
global $uactividadesIdealeasevista;

//Creates the form
$uactividadesIdealeasevista=new uactividadesIdealeasevista($application);

//Read from resource file
$uactividadesIdealeasevista->loadResource(__FILE__);

//Shows the form
$uactividadesIdealeasevista->show();
