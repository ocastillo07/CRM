<?php
<object class="urhdescpuestosderechos" name="urhdescpuestosderechos" baseclass="page">
  <property name="Background"></property>
  <property name="Caption">Derechos en Descripcion de Puestos</property>
  <property name="Color">#C0C0C0</property>
  <property name="DocType">dtNone</property>
  <property name="Height">600</property>
  <property name="IsMaster">0</property>
  <property name="Name">urhdescpuestosderechos</property>
  <property name="Width">800</property>
  <property name="OnShow">urhdescpuestosderechosShow</property>
  <property name="jsOnLoad">urhdescpuestosderechosJSLoad</property>
  ...
  <object class="Label" name="lbpuesto" >
...
&lt;P&gt;daly&lt;/P&gt;]]></property>
    ...
    <property name="Left">9</property>
    <property name="Name">lbpuesto</property>
    <property name="ParentFont">0</property>
    <property name="Top">61</property>
    <property name="Width">783</property>
  </object>
  <object class="Label" name="lbpuestos" >
  ...
  <object class="Label" name="lbareas" >
    <property name="Caption">...</property>
    <property name="Color">#C0C0C0</property>
    <property name="Height">13</property>
    <property name="Left">9</property>
    <property name="Name">lbareas</property>
    <property name="Top">152</property>
