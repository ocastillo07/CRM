...
if (isset($GLOBALS['_transient']))
{
        if (isset($GLOBALS['_transient']['static']))
        {
                ...
                {
                        if (is_object($GLOBALS['_transient']['static']['nusoap_base'])) $GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel = 9;
                }
        }
}
        ...
        function nusoap_base() {
          if (isset($GLOBALS['_transient']))
          {
            if (isset($GLOBALS['_transient']['static']))
            {
                if (isset($GLOBALS['_transient']['static']['nusoap_base']))
                {
                        if (is_object($GLOBALS['_transient']['static']['nusoap_base'])) $this->debugLevel = $GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel;
                }
            }
          }
        }
