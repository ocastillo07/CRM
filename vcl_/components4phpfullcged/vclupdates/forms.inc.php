...
class Application extends Component
{
        ...
        /**
        * Autodetects the language for the user browser and changes the Language
...
/**
 * Function responsible to dispatch ajax requests to the right events, this function
 * is used by the Page when UseAjax is true to process the ajax requests and fire the right
 * events.
 *
...
class Window extends QWidget
{
        ...
        /**
        * Specifies if the window is modal or not, a modal window is the one that
        * forces the user to make an action (close the window, click a button, etc)
        * before it can continue with the program
        *
        * @return boolean
        */
        ...
        /**
        * Specifies if the window is visible or not, modal windows are not visible
        * and should be shown using code
        *
        * @return boolean
        */
        ...
        /**
        * Specifies if the window allows to be resized, if false, user cannot
        ...
        */
        ...
        /**
        * Specifies if the window allows to be moved, if false, window will remain
        * at the position it was shown
        *
        * @return boolean
        */
...
class Page extends CustomPage
{
    ...
    protected $_encoding='Western European (ISO)     |iso-8859-1';
        ...
        /**
        * Specifies the encoding to use for the page, this encoding is set on the charset
        * of the generated HTML and it's different from the Charset you setup PHP to work on.
        *
        * @return enum
        */
    ...
    protected $_formencoding="";
        ...
        /**
        * Specifies the encoding to use the form generated by the Page, every Page
        * component generates a Form (unless IsForm is false) to allow process events,
    ...
    function defaultFormEncoding() { return ""; }
        ...
        /**
        * Specifies the background for the form, the background should be an
        * image file, and will be used to fill the page background with it.
        *
        * @return string
        */
        ...
        /**
        * Specifies the engine to be used to render this page using templates, valid
        * values for this property are registered Template Plugins, by default, only
        * Smarty is included, checkout here to know more:
        *
        * @link http://www.qadram.com/vcl4php/wiki/index.php/Users_guide:Smarty_Templates
        *
        * @return string
        */
    ...
    //Action property
        ...
        /**
        * Specifies the name of the template file to be used to render this page, usually
        * is an HTML file with some placeholders to allow insert information inside.
        ...
        *
        * If set to false, ajaxcalls won't be processed, click here to know more:
        * http://www.qadram.com/vcl4php/wiki/index.php/CWG:Ajax_Integration
        *
        * @return boolean
        */
        ...
        /**
        * Specifies the language to be used when rendering this page, by setting it
        * to a different value than (default), the Page will look for an file
        ...
        * @link http://www.qadram.com/vcl4php/wiki/index.php/Users_guide:Localizing_the_Interface
        *
        * @return string
        */
        function getLanguage() { return $this->_language; }
 ...
 * the template and tries to insert components inside it. To make it work you
 ...
 */
    ...
    /**
    * Fired when the template is about to be rendered, this event is only fired
    ...
    * @link http://www.qadram.com/vcl4php/wiki/index.php/Users_guide:Smarty_Templates#Accessing_the_internal_Smarty_object
    */
...
//                $height="";
    ...
    function defaultRightMargin() { return 0; }
        ...
        /**
        * If false, the form doesn't dump any header code, this is useful, for example
        * if you want to include your form inside another form, so it doesn't generate
    ...
    function defaultIsForm() { return 1; }
        ...
        * @link http://www.qadram.com/vcl4php/wiki/index.php/Users_guide:Page_Inheritance
        *
        * @return boolean
        */
    ...
    function setIsMaster($value) { $this->_ismaster=$value; }
        ...
        /**
        * If false, the form doesn't dump any footer code, this is useful, for example
        * if you want to include your form inside another form, so it doesn't generate
        * a full HTML document
        * @return boolean
        */
