<?php
<object class="ureunidmed" name="ureunidmed" baseclass="page">
  ...
  <property name="Name">ureunidmed</property>
  <property name="Width">800</property>
  <property name="OnShow">ureunidmedShow</property>
  ...
  <object class="Label" name="Label1" >
    <property name="Caption">Id Unidad</property>
    <property name="Color">#C0C0C0</property>
    <property name="Font">
  ...
  <object class="Edit" name="eedidunidad" >
    <property name="Height">21</property>
    <property name="Left">24</property>
    <property name="Name">eedidunidad</property>
    <property name="ParentColor">0</property>
  ...
  <object class="MySQLTable" name="tblunidades" >
    ...
    <property name="Name">tblunidades</property>
    <property name="TableName">reunidadmedida</property>
  </object>
