<?php
<object class="umonedasvista" name="umonedasvista" baseclass="page">
  <property name="Background"></property>
  <property name="Caption">Monedas</property>
  <property name="DocType">dtNone</property>
  <property name="Height">600</property>
  <property name="IsMaster">0</property>
  <property name="Name">umonedasvista</property>
  <property name="Width">800</property>
  <property name="OnCreate">umonedasvistaCreate</property>
  <property name="OnShow">umonedasvistaShow</property>
  <property name="jsOnLoad">umonedasvistaJSLoad</property>
  ...
  <object class="DBGrid" name="grid" >
    ...
    <property name="Width">774</property>
