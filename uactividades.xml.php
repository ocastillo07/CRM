<?php
<object class="uactividades" name="uactividades" baseclass="page">
  ...
  <property name="Name">uactividades</property>
  <property name="UseAjax">1</property>
  <property name="UseAjaxDebug">1</property>
  <property name="Width">800</property>
  <property name="OnShow">uactividadesShow</property>
  ...
  <object class="Label" name="lbvin" >
    <property name="Caption">VIN</property>
    <property name="Color">#C0C0C0</property>
    <property name="Font">
        <property name="Weight">bold</property>
    </property>
  ...
  <object class="MySQLTable" name="tbactividades" >
    ...
    <property name="TableName">actividades</property>
  </object>
