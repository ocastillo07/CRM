...
class uactividadesxasignarvista extends Page
{
       ...
       function uactividadesxasignarvistaShow($sender, $params)
       {
         ...
         if(isset($_GET["idpuesto"]) && $_GET["idpuesto"] == '24')
            $this->lbtitulo->Caption= $this->Caption . ' Promotores';
         else if(isset($_GET["idpuesto"]) && $_GET["idpuesto"] == '29')
            $this->lbtitulo->Caption= $this->Caption . ' Asesores';
       ...
       function filtro()
       {
        ...
        if(Derechos('TODACTIVXASIG')==true)
            $sql=$sql.' where a.idvendedor>0 and u.idpuesto = ' . $_GET["idpuesto"]. ' '.
